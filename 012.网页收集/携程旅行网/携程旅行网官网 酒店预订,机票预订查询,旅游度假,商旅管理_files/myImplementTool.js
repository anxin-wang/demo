    ...
    return function () {
        ...
        var tool = {
            ...
            tool_contentPoolCreatationFn: function () {
                ...
                var implementLink = [{
                    key: "train", url: "http://trains.ctrip.com/TrainSchedule/", title: "火车查询"
                }, {
                    key: "lowfly", url: "http://flights.ctrip.com/domestic/MyToolBox/Option.aspx", title: "低价机票早知道"
                }, {
                    key: "flytime", url: "http://flights.ctrip.com/schedule/", title: "航班时刻"
                }, {
                    key: "credit", url: "http://pages.ctrip.com/commerce/promote/AllianceCard/200706/xyk/lyxykindex.htm", title: "申请携程信用卡"
                }, {
                    key: "weather", url: "http://huodong.ctrip.com/Activity-Booking-ShoppingWebSite/Marketing/WiFiMarketing.aspx", title: "旅行天气"
                }, {
                    key: "car", url: "http://car.ctrip.com/", title: "用车服务"
                }, {
                    key: "cartime", url: "http://bus.ctrip.com/schedule-sitemap.html", title: "汽车时刻表"
                }, {
                    key: "hotel_join", url: "http://hotels.ctrip.com/jiameng#ctm_ref=ctr_hp_tool_hsu_i_1", title: "酒店加盟"
                }, {
                    key: "city", url: "http://piao.ctrip.com/citylist.html", title: "城市景点大全"
                }, {
                    key: "wifi", url: "http://hotels.ctrip.com/jiameng#ctm_ref=ctr_hp_tool_hsu_i_1", title: "出境上网服务"
                }
                ];
