                    ...
                    try {
                        ...
                        if (responseObj == undefined) {
                            ...
                            for (var i = 0; i < responseObj.length; i++) {
                                var liItem = [
                                            '<li>',
                                            '<a href="{0}" target="_blank" class="borwsing_link">',
                                ...
                                var liItemFormatted = liItem.format(responseObj[i].sburl, responseObj[i].sbimg, responseObj[i].sbtitle, responseObj[i].sbname, responseObj[i].sbstar, responseObj[i].sbtitle,
