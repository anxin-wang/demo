define(["webConsole"], function (webConsole) {
    ...
    return function () {
        ...
        var tool = {
            ...
            tool_iconBody: '<a id="feedbackTag" href="http://my.' + hostName + '/uxp/Community/CommunityAdvice.aspx"  target="_blank" class="stool_icon stool_feedback">意见反馈</a><p id="feedbackTip" class="stool_hover_title stool_hover_feedback" style="display:none;">意见反馈</p>', //标签内容
